...
// LOGIC   see functions.php M13 #5-2
try{
	$conn = makePDOConn();
	switch(@$_GET['action']) {	
		case "update":
...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
	...
	<div class="form-control">
		...
		<input class="form-input" name="product-images" id ="product-thumbnail" type="text" value="$o->images" placeholder="Enter the Product Images">
	</div>
	<div class="form-control">
