...
return $r.<<<HTML
	<div class="display-flex">
		...
		<div class="flex-stretch">
			...
			<form action="m12/cart_actions.php?action=delete-cart-item" method="post">
		...
		<div class="flex-none">
			...
			<form action="m12/cart_actions.php?action=update-cart-item" method="post" onchange="this.submit()">
				<input type="hidden" name="id" value="$o->id">
...
<div class="card-section">
	<a href="../so.eunice/m12/product_checkout.php" class="form-button">Checkout</a>
</div>
