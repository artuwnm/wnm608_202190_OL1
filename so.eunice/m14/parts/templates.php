...
return $r.<<<HTML
<a class="col-xs-12 col-md-3" href="../so.eunice/m14/product_item.php?id=$o->id">
...
return $r.<<<HTML
	<div class="display-flex">
		...
		<div class="flex-stretch">
			...
			<form action="m14/cart_actions.php?action=delete-cart-item" method="post">
		...
		<div class="flex-none">
			...
			<form action="m14/cart_actions.php?action=update-cart-item" method="post" onchange="this.submit()">
				<input type="hidden" name="id" value="$o->id">
...
function recommendedAnything($cat,$limit=8) {
