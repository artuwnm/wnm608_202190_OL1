...
$image_elements = array_reduce($images,function($r,$o){
	return $r. "<img src='../so.eunice/m13/img/$o'>";
});
...
<head>
	...
	<script src="../so.eunice/m13/js/product-thumbs.js"></script>
</head>
<body>
	...
	<div class="container">
			<div class="grid gap">
				...
				<div class="col-xs-12 col-md-6">
					<form class="card soft flat" method="post" action="m13/cart_actions.php?action=add-to-cart">
