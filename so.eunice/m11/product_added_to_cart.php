	...
	<?php include "parts/navbar.php"; ?>
		...
		<div class="card soft">
			...
			<div class="display-flex">
				<div class="flex-none"><a href="../so.eunice/m11/product_list.php">Continue Shopping</a></div>
				<div class="flex-stretch"></div>
				<div class="flex-none"><a href="../so.eunice/m11/product_cart.php">Got to Cart</a></div>
			</div>
