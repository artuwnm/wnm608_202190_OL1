...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
	...
	<div class="form-control"  for="user-type">
		<label class="form-label">Type</label>
		<input class="form-input" name="user-type" id="user-type" type="text" value = "$user->type"  placeholder="Enter the User Type" >
	</div>

	<div class="form-control"  for="user-email">
		<label class="form-label">Email</label>
		<input class="form-input" name="user-email" id="user-email" type="text" value ="$user->email"  placeholder="Enter the User Email">
	</div>

	<div class="form-control" for="user-classes">
		<label class="form-label">Classes</label>
		<input class="form-input" name="user-classes" id="user-classes" type="text" value ="$classes" placeholder="Enter the User Classes, comma seperated">
	</div>

	<div class="form-control">
		<input class="form-button" type="submit" value ="Save Changes"></span>
	</div>
</form>
